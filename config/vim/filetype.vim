...
" DOT
au BufNewFile,BufRead *.dot			setf dot | compiler rant | map <F5> :w<cr>:make dot<cr>
...
au BufNewFile,BufRead *.java,*.jav		compiler rant
au BufNewFile,BufRead *.java,*.jav		map <F5> :w<cr>:make java<cr>
au BufNewFile,BufRead *.java,*.jav		map <F6> :w<cr>:make javac<cr>

"JUnit
au BufNewFile,BufRead *Test.java,*Test.jav 
			\map <F5> :w<cr>:make unit_test test=%<cr>
...
" Java Server Pages
au BufNewFile,BufRead *.jsp			setf jsp | compiler rant | 
			\map <F5> :w<cr>:make deploy<cr>
...
" Rake
au BufNewFile,BufRead [Rr]akefile.rb,[Rr]akefile,*.rake setf ruby | compiler rake |
			\ map <F5> :w<cr>:make<cr>

" Ruby
au BufNewFile,BufRead *.rb,*.rbw,*.gem,*.gemspec,[Rr]akefile setf ruby | compiler rake |
			\ map <F5> :w<cr>:make<cr>

" Runit
au BufNewFile,BufRead *test.rb setf ruby | compiler rubyunit |
			\ map <F5> :w<cr>:make<cr>

"au BufNewFile,BufRead *test.rb	compiler rubyunit | map <F5> :w<cr>:make %<cr>
au BufNewFile,BufRead [Rr]antfile,*.rant	setf ruby | compiler rant
...
" Vim script
au BufNewFile,BufRead *.vim,*.vba,.exrc,_exrc	setf vim | compiler rant |
			\ map <F5> :w<cr>:make deploy<cr>
...
"docbook
au BufNewFile,BufRead mras.xml,*.chapter.xml,*.reference.xml,*glossary.xml,*.section.xml,*bibliography.xml
	\   let b:docbk_type="xml" |
	\   setf docbk |
	\   compiler rake |
  \   :map <F5> :w<cr>:make xslt<cr> 
...
" Xslt
au BufNewFile,BufRead *.xsl,*.xslt		setf xslt | compiler rant 
			\| map <F5> :w<cr>:make xslt<cr>
...
" Yaml
au BufNewFile,BufRead *.yaml,*.yml		setf yaml | compiler rake
